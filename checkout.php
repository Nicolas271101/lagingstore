...
<html>
<head>
<title>LAGING STORE - Checkout</title>
<!-- for-mobile-apps -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="LAGING STORE, EL's Club" />
...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<h1>Terima kasih, <?=$_SESSION['name']?> telah membeli <?php echo $itungtrans3 ?> barang di LAGING STORE</span></h1>
...
<div class="footer">
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2020 EL's Club. All rights reserved</p>
			</div>
		</div>
